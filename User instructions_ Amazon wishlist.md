...
2. Specify the following parameters:
   ...
   |     **Privacy**                             |     Set the privacy status: <ul><li>**Public** to let anyone search and find your list.</li><li>**Shared** to let the people with the direct link see your list. <li>**Private** to hide the list from everyone but you.</li></ul>                                                                                                            |
