...
2. Specify the following parameters:
   ...
   |     **Privacy**                             |     Set the privacy status: <ul><li>**Public** lets anyone search and find your list.</li><li>**Shared** lets the people with the direct link see your list. <li>**Private** lets only you to see the list.</li></ul>                                                                                                            |
